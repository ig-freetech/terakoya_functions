...
const TERAKOYA_TYPE_RADIO_DATA: Array<GroupInputData> = [
  ...
  { text: "長南校", value: TERAKOYA_TYPE.CHONAN.toString() },
  { text: "谷口校", value: TERAKOYA_TYPE.TANIGUCHI.toString() },
  { text: "芦田校", value: TERAKOYA_TYPE.ASHIDA.toString() },
  { text: "忠海校", value: TERAKOYA_TYPE.TADANOUMI.toString() },
  { text: "土肥校", value: TERAKOYA_TYPE.TOI.toString() },
  { text: "泊川校", value: TERAKOYA_TYPE.TOMARIKAWA.toString() },
  { text: "菅田校", value: TERAKOYA_TYPE.SUGATA.toString() },
  { text: "山守校", value: TERAKOYA_TYPE.YAMAMORI.toString()} ,
  { text: "片田校", value: TERAKOYA_TYPE.KATATA.toString() },
  { text: "中松校", value: TERAKOYA_TYPE.NAKAMATSU.toString() },
  { text: "中津原校", value: TERAKOYA_TYPE.NAKATSUBARU.toString() },
  { text: "長若校", value: TERAKOYA_TYPE.NAGAWAKA.toString() },
  { text: "外丸校", value: TERAKOYA_TYPE.TOMARU.toString() },
  { text: "上ノ加江校", value: TERAKOYA_TYPE.KAMINOKAE.toString() },
  { text: "下市校", value: TERAKOYA_TYPE.SHIMOICHI.toString() },
  { text: "修正校", value: TERAKOYA_TYPE.SYUSEI.toString() },
